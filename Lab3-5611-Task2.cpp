...
#define ProgName	"Lab3-5611-Task2"
#define LabNo		3
...
int main(int argc, char *argv[])
{
	...
	*/
	...
	for (colour = 0; colour < coloursUsed; colour++) {
		colourPalette[colour][0] = 0xFF - colourPalette[colour][0];
		colourPalette[colour][1] = 0xFF - colourPalette[colour][1];
		colourPalette[colour][2] = 0xFF - colourPalette[colour][2];
	}
